# Capability: unit-test-runner

## Purpose

Unit testing runner configuration for pi-subagent-herdr using Vitest with a node:test shim, c8 Istanbul JSON coverage, and preserved serial integration runner.
