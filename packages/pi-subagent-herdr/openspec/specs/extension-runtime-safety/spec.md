...
Safety and lifecycle rules for extension runtime execution, preventing discovery-time runtime poisoning, restricting completion API ownership to active bound sessions, enforcing session-affine delivery, and handling inactive runtime deferral and recovery.
